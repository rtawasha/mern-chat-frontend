...
const Register = () => {
  ...
  const handleSubmit = async(e) => { 
    ...
    try{
      ...
      // const { data } = await axios.post(`${apiURL}/api/users/register`, {username, email, password});
    ...
    setLoading(false); //!this is removed after registration
  }
  return (
    <Box
      w="100%"
      ...
      >
        ...
        >
          ...
          <Box display={["block", "block", "none"]} textAlign="center" mb={6}>
            <Text fontSize="2xl" fontWeight="bold" color="gray.800"> Create Account </Text>
          </Box>
          ...
          <VStack spacing={5} w="100%" maxW="400px" mx="auto">
            <FormControl id="username" isRequired >
              ...
              <Input type="text" name="username" placeholder="Choose a username" value={username}
                onChange={(e) => setUsername(e.target.value)}
                size="lg" bg="gray.50" borderColor="gray.200" _hover={{ borderColor: "indigo.500" }} _focus={{ borderColor: "indigo.500" }} />
            </FormControl>
            ...
            <FormControl id="password" isRequired>
              ...
              <Input type="password" name="password" placeholder="Create a password" value={password} 
            ...
            <Button 
              ...
              isLoading={loading}
              colorScheme="purple" width="100%" transform="auto" _hover={{ scale: 1.05 }} 
              transition="transform 0.2s" size="lg" fontSize="md" mt={4}   >
              Create Account
            </Button>
            ...
            <Text color="gray.600" pt={4}>
              ...
              <Link
                to="/login" 
                style={{ color: "var(--chakra-colors-indigo-600)", fontWeight: "500", transition: "color 0.2s", }} 
